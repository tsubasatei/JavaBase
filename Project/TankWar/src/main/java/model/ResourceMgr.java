...
public class ResourceMgr {
    ...
    static {
        try {
            ...
            goodTankL = dp.ImageUtil.rotateImage(goodTankU, -90);
            goodTankR = dp.ImageUtil.rotateImage(goodTankU, 90);
            goodTankD = dp.ImageUtil.rotateImage(goodTankU, 180);

            badTankU = ImageIO.read(ResourceMgr.class.getClassLoader().getResourceAsStream("images/BadTank1.png"));
            badTankL = dp.ImageUtil.rotateImage(goodTankU, -90);
            badTankR = dp.ImageUtil.rotateImage(goodTankU, 90);
            badTankD = dp.ImageUtil.rotateImage(goodTankU, 180);

            bulletU = ImageIO.read(ResourceMgr.class.getClassLoader().getResourceAsStream("images/bulletU.gif"));
            bulletL = dp.ImageUtil.rotateImage(bulletU, -90);
            bulletR = dp.ImageUtil.rotateImage(bulletU, 90);
