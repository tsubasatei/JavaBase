...
public class MyConnectionPool {
    ...
    static{
        ...
        driver = propertiesUtil.getProperties("jdbc.driver");
        url = propertiesUtil.getProperties("jdbc.url");
        user=propertiesUtil.getProperties("jdbc.user");
        password=propertiesUtil.getProperties("jdbc.password");
        initSize= Integer.parseInt(propertiesUtil.getProperties("jdbc.initSize"));
        maxSize= Integer.parseInt(propertiesUtil.getProperties("jdbc.maxSize"));
