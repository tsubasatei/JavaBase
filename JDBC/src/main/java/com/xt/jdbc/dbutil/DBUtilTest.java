...
public class DBUtilTest {
    ...
    public static void testQuery() throws SQLException {
        ...
        Emp emp = queryRunner.query(connection, sql, new BeanHandler<>(Emp.class), 7369);
    ...
    public static void testArray() throws SQLException {
        ...
        String sql = "select * from emp where empno = ?";
        QueryRunner runner = new QueryRunner();
        Object[] object = runner.query(connection, sql, new ArrayHandler(), 7369);
        for (Object o : object) {
    ...
    public static void testMyHandler() throws SQLException {
        ...
        String sql = "select * from emp where empno = ?";
        QueryRunner runner = new QueryRunner();
        Emp emp = runner.query(connection, sql, resultSet -> {
            if (resultSet.next()) {
                Emp e = new Emp();
